...
public class ImageController {
	...
	@RequestMapping(value="generalUpload2")
	public String generalUpload2(HttpServletRequest req,
			HttpSession session, Image image) throws Exception {
	...
	// HTML 5 upload
	@RequestMapping(value="html5Upload2")
	public void html5Upload2(HttpServletRequest req,
			HttpServletResponse resp,
			HttpSession session) throws Exception {
