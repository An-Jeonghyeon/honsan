...
function deletbutton(num){
	if(confirm("게시물을 삭제 하시겠습니까?")){
		var q="num="+num+"&${query}";
		var url="${pageContext.request.contextPath}/dressTip/delete?"+q;
		location.href=url;
	}
}
...
function updatebutton(num){	
	if(confirm("게시물을 수정 하시겠습니까?")){
		...
		var url="${pageContext.request.contextPath}/dressTip/update?"+q;
		location.href=url;
	}
}
  ...
  <div class="articleMainBody">
                <div class="articleMainHeader">
                    <div class="articleGo">
                        <span><a href="${pageContext.request.contextPath}/dressTip/list">옷 보관법 게시판&gt;</a></span>
                    </div>
