    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand waves-effect waves-dark" href="${pageContext.request.contextPath}/home"><i class="large material-icons">track_changes</i> <strong>target</strong></a>
...
<ul id="dropdown4" class="dropdown-content dropdown-tasks w250 taskList">
  <li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/adm/health" class="active-menu waves-effect waves-dark"><i class="fa fa-table"></i>[하루운동챌린지]관리</a>
                    </li>
                    <li>
	...
	<script src="<c:url value="/resources/assets/materialize/js/materialize.min.js" />"></script>
	...
	<script src="<c:url value="/resources/assets/js/easypiechart.js" />"></script>
	<script src="<c:url value="/resources/assets/js/easypiechart-data.js" />"></script>
	
	 <script src="<c:url value="/resources/assets/js/Lightweight-Chart/jquery.chart.js" />"></script>
	 <!-- DATA TABLE SCRIPTS -->
