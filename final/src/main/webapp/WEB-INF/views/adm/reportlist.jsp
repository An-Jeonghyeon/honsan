    ...
    <div id="wrapper">
         <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand waves-effect waves-dark" href="chart.jsp"> <strong>honsan</strong></a>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/adm/reportlist" class="active-menu waves-effect waves-dark"><i class="fa fa-qrcode"></i> 게시판 정지 관련</a>
                    </li>
