					                ...
					                <div class="ch_content_basic">
					                    ...
					                    <table border="1" class="ch_table">
					                        <tr>
					                            ...
					                            <td class="chname"><input type="text" class="form-control" name="" id=""></td>
					                        </tr>
					                        <tr>
					                            <th scope="row">간단설명</th>
					                            <td class="chsub"><input type="text"></td>
					                        </tr>
					                        <tr>
					                            <th scope="row">상세설명</th>
					                            <td class="chdet"><textarea name="" id="" cols="" rows="15" style="margin: 0px; width: 770px; height: 207px;"></textarea></td>
					                        </tr>
					                        <tr>
					                            <th scope="row">챌린지 기간</th>
					                            <td class="chdate"><input type="text"> 일</td>
					                        </tr>
					                        <tr>
					                            <th scope="row">총 칼로리</th>
					                            <td class="chkcal"><input type="text"> kcal</td>
					                        </tr>
					                        <tr>
